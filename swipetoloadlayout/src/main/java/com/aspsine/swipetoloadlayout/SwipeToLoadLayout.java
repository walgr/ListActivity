...
public class SwipeToLoadLayout extends ViewGroup {
     ...
     * 加载完成
     * */
    private LoadMoreAnimListener mLoadMoreAnimListener;
    ...
    public CustomSwipeRefreshListener getSwipeRefreshListener() {
        return mSwipeRefreshListener;
    }

    public void setSwipeRefreshListener(CustomSwipeRefreshListener swipeRefreshListener) {
    ...
    public void setLoadingMore(boolean loadingMore) {
        setLoadingMore(loadingMore, null);
    }

    public void setLoadingMore(boolean loadingMore, LoadMoreAnimListener loadMoreAnimListener) {
        this.mLoadMoreAnimListener = loadMoreAnimListener;
    ...
    private void scrollLoadingMoreToDefault() {
        ...
        if (mLoadMoreAnimListener != null) {
            mLoadMoreAnimListener.onLoadMoreAnim(mLoadMoreCompleteToDefaultScrollingDuration);
            mLoadMoreAnimListener = null;
        }
    }
    ...
    RefreshCallback mRefreshCallback = new RefreshCallback() {
        ...
        public void onReset() {
            ...
            if (mSwipeRefreshListener != null) {
                mSwipeRefreshListener.onComplete();
            }
        }
    };
