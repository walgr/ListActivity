...
import com.base.listactivity.widget.BaseNoRefreshSingleListView
 ...
 * 单类型的列表Activity基类
 */
abstract class BaseNoRefreshSingleListActivity<T>
    : AppCompatActivity(),
    ...
    open lateinit var baseNoRefreshListView: BaseNoRefreshSingleListView<T>
    ...
    open fun initBaseView(): BaseNoRefreshSingleListView<T> {
        return BaseNoRefreshSingleListView(
            this,
